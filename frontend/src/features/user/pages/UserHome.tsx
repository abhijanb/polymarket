    ...
    <div className="flex h-screen overflow-hidden bg-surface-canvas font-sans">
      <header className="fixed top-0 left-0 right-0 h-16 bg-surface border-b border-outline-variant z-50 flex items-center px-[24px]">
          ...
          <div className="flex items-center gap-6">
            {topNavLinks.map((link) => (
              <a
                ...
                className="text-on-surface-variant hover:text-on-surface text-[14px] font-medium transition-colors"
                style={{ fontFamily: "Inter" }}
              >
                {link}
              </a>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="w-8 h-8 rounded-full overflow-hidden border border-outline-variant bg-primary/20">
            <img
              alt="Profile"
      ...
      <nav className="fixed left-0 top-16 w-[250px] h-[calc(100vh-4rem)] overflow-y-auto bg-surface border-r border-outline-variant z-40 flex flex-col hidden md:flex">
        <div className="p-4 border-b border-outline-variant">
          <h2 className="text-[16px] font-bold text-on-surface" style={{ fontFamily: "Inter" }}>
            Markets
          </h2>
        ...
        <div className="border-t border-outline-variant p-4 space-y-2">
          <a
            href="#settings"
            className="flex items-center gap-3 px-4 py-2 text-[14px] text-on-surface-variant hover:text-on-surface transition-colors"
            style={{ fontFamily: "Inter" }}
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2 text-[14px] text-on-surface-variant hover:text-on-surface transition-colors text-left"
            style={{ fontFamily: "Inter" }}
          >
        ...
        <div className="p-4">
          <button className="w-full bg-primary text-on-primary text-[14px] font-bold py-2 rounded-sm hover:opacity-90 active:opacity-80 transition-all uppercase tracking-wider">
            CREATE MARKET
          </button>
        </div>
      </nav>

      <main className="md:ml-[250px] mt-16 h-[calc(100vh-64px)] overflow-y-auto p-[24px] bg-surface-canvas">
